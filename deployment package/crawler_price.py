...
def getResultPrice(intent, session):
    card_title = "Trending Phones names"
    session_attributes = {}
    should_end_session = False

    price = intent['slots']['number']['value']
    prices = ['2000', '4000', '7000', '10000', '13000', '16000', '20000', '25000', '30000', '50000', 'Max']

    if price not in prices:
        speech_output = "Price not found in price filter"
    else:
        ...
        soup = get_soup(flipkart_mobile_url + price)
    ...
    reprompt_text = "I didn't get it, Can you repeat whats your budget ?"
