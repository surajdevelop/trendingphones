...
# --------------- Methods to run brand crawler ----------------------

def getResultBrand(intent, session):
    card_title = "Trending Phones names"
    session_attributes = {}
    should_end_session = False
    brand = intent['slots']['brand']['value']
    flipkart_mobile_url = 'https://www.flipkart.com/mobiles/pr?sid=tyy%2C4io&marketplace=FLIPKART&p%5B%5D=facets.brand%255B%255D%3D'
    soup = get_soup(flipkart_mobile_url + brand)
    ...
    reprompt_text = "I didn't get it, Can you repeat whats your brand ?"
